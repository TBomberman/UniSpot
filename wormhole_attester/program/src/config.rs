//! On-chain state for the unispot2wormhole SOL contract.
//!
...
//! 1. Add a next UniSpot2WormholeConfigVX struct,
//! e.g. UniSpot2WormholeConfigV3,
//! 2. Add a P2WConfigAccountVX type alias with a unique seed str
//! 3. Implement From<UniSpot2WormholeConfigVY> for the new struct,
//! e.g. From<UniSpot2WormholeConfigV2> for UniSpot2WormholeConfigV3
//! 4. Advance UniSpot2WormholeConfig, P2WConfigAccount,
//! OldUniSpot2WormholeConfig, OldP2WConfigAccount typedefs to use the
...
pub struct UniSpot2WormholeConfigV1 {
    ///  Authority owning this contract
    pub owner:          Pubkey,
    /// Wormhole bridge program
    pub wh_prog:        Pubkey,
    /// Authority owning UniSpot price data
    pub unispot_owner:     Pubkey,
    pub max_batch_size: u16,
}

pub type P2WConfigAccountV1<'b, const IS_INITIALIZED: AccountState> =
    Derive<Data<'b, UniSpot2WormholeConfigV1, { IS_INITIALIZED }>, "unispot2wormhole-config">;

/// Added is_active
#[derive(Clone, Default, BorshDeserialize, BorshSerialize)]
#[cfg_attr(feature = "client", derive(Debug))]
pub struct UniSpot2WormholeConfigV2 {
    ///  Authority owning this contract
    pub owner:          Pubkey,
    /// Wormhole bridge program
    pub wh_prog:        Pubkey,
...
/// (e.g. unispot2wormhole-config-v2 -> unispot2wormhole-config-v2.1). This
/// saves a lot of time coding around this edge case.
pub type P2WConfigAccountV2<'b, const IS_INITIALIZED: AccountState> =
    Derive<Data<'b, UniSpot2WormholeConfigV2, { IS_INITIALIZED }>, "unispot2wormhole-config-v2.1">;

impl From<UniSpot2WormholeConfigV1> for UniSpot2WormholeConfigV2 {
    fn from(old: UniSpot2WormholeConfigV1) -> Self {
        let UniSpot2WormholeConfigV1 {
            owner,
            wh_prog,
            unispot_owner,
            max_batch_size,
...
#[cfg_attr(feature = "client", derive(Debug))]
pub struct UniSpot2WormholeConfigV3 {
    ///  Authority owning this contract
    pub owner:          Pubkey,
    /// Wormhole bridge program
    pub wh_prog:        Pubkey,
...
pub type P2WConfigAccountV3<'b, const IS_INITIALIZED: AccountState> =
    Derive<Data<'b, UniSpot2WormholeConfigV3, { IS_INITIALIZED }>, "unispot2wormhole-config-v3">;

impl From<UniSpot2WormholeConfigV2> for UniSpot2WormholeConfigV3 {
    fn from(old: UniSpot2WormholeConfigV2) -> Self {
        let UniSpot2WormholeConfigV2 {
            owner,
            wh_prog,
            unispot_owner,
            max_batch_size,
