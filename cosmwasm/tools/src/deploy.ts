...
//   }
  ...
  const deployer = DeployerFactory.create(
    NetworkConfig[NETWORKS.INJECTIVE_TESTNET],
...
//   );
  ...
  let contract = "unispot_cosmwasm.wasm";
  codeIds[contract] = 1016;
  ...
  console.log("codeIds[contract]", codeIds[contract]);
  console.log("inst_msg", inst_msg);
  addresses[contract] = await deployer.instantiate(
    codeIds[contract],
    inst_msg,
    "unispot"
